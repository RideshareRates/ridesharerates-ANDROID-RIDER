...
public class PendingPojo implements Serializable {
    ...
    @Expose
    private String totalWaitingCharge;
    ...
    public String getTotalWaitingCharge() {
        return totalWaitingCharge;
    }
    public void setTotalWaitingCharge(String totalWaitingCharge) {
        this.totalWaitingCharge = totalWaitingCharge;
    }
