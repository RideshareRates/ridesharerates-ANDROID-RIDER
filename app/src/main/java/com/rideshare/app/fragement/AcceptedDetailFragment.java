...
public class AcceptedDetailFragment extends FragmentManagePermission
    ...
    TextView title, drivername, mobilenumber, pickup_location, drop_location, stop_title, stop_location, fare, timeandate, payment_status, pause_recording_txt,
            txtAmount, txtDistance, txtStatus, txtDateTime, txt_cancellation_charge;
...
//            setImageFromUrl.execute();
    ...
    public void BindView() {
        ...
        stop_title = (TextView) view.findViewById(R.id.tv_stop_title);
        stop_location = (TextView) view.findViewById(R.id.txt_stoplocation);
        ...
        txt_cancellation_charge = view.findViewById(R.id.txt_cancellation_charge);
        ...
        if (bundle != null) {
            ...
            if (!pojo.getStops().isEmpty() && !Utils.isNullOrEmpty(pojo.getStops().get(0).getMidstopAddress())) {
                stop_title.setVisibility(View.VISIBLE);
                stop_location.setVisibility(View.VISIBLE);
                stop_location.setText(pojo.getStops().get(0).getMidstopAddress());
            }
            ...
            txt_cancellation_charge.setText("$" + pojo.getCancellationCharge());
