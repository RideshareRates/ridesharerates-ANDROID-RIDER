...
public class LoginActivity extends ActivityManagePermission implements View.OnClickListener {
    ...
    // To validate all the ruquired fields
                    ...
                    if (response.has("status") && response.getBoolean("status")) {
                        ...
                        } else //If card to be add
                        {
                            if (!response.getJSONObject("data").getBoolean("is_card")) {
                                ...
                                SessionManager.setKEY(response.getString("token"));
                                Toast.makeText(LoginActivity.this, "Please add your payment details.", Toast.LENGTH_LONG).show();
                ...
                try {
                    ...
                    switch (exception.getStatusCode()) {
                        ...
                        case LocationSettingsStatusCodes.SETTINGS_CHANGE_UNAVAILABLE:
                            // Location settings are not satisfied, and this cannot be fixed by showing the user a dialog.
                            // You could inform the user about the problem and/or take some alternative action.
                            break;
                    }
                }
            }
...
//                    Utils.showAlertToTurnOnGPS(this);
                    UtilsNew.Companion.showAlertToTurnOnGPS(this);
                }
                break;
        }
    }
