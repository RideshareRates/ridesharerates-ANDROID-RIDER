    ...
    private void bindView() {
        ...
        btnAdd.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                final String finalLastFourDigits = lastFourDigits;
...
//                        Card card = Card.create(lastFourDigits, Integer.valueOf(date[0]),
                                ...
                                new Stripe(AddPaymentMethodActivity.this, Server.SPIKE_KEY)
                                        .createCardToken(card, new ApiResultCallback<Token>() {
                                            ...
                                            public void onSuccess(@NonNull Token token) {
                                                ...
                                                saveCard(token.getId(), finalLastFourDigits, date[1], date[0], name, token.getCard().getBrand().name(), finalBillingAddress);
                                            ...
                                            public void onError(@NonNull Exception e) {
                                                // removed log of stripe while adding card
                                                Toast.makeText(AddPaymentMethodActivity.this, e.getMessage(), Toast.LENGTH_SHORT).show();
//                                                Toast.makeText(AddPaymentMethodActivity.this, "Something went wrong. Please try again later.", Toast.LENGTH_SHORT).show();
                                            }
                                        });
                            } else {
        ...
        if (CheckConnection.haveNetworkConnection(this)) {
            ...
            Server.post("make_default", params, new JsonHttpResponseHandler() {
                ...
                public void onSuccess(int statusCode, Header[] headers, JSONObject response) {
                    ...
                    Toast.makeText(AddPaymentMethodActivity.this, "Making primary card", Toast.LENGTH_SHORT).show();
...
//                    Toast.makeText(AddPaymentMethodActivity.this, responseString, Toast.LENGTH_SHORT).show();
    ...
    private void getStripekey(Context context) {
